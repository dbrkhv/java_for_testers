...
public class GroupCreationTests {
    ...
    public void canCreateGroup() {
        ...
        driver.findElement(By.name("group_name")).sendKeys("group 1 name");
        driver.findElement(By.name("group_header")).click();
        driver.findElement(By.name("group_header")).sendKeys("group 1 header");
        driver.findElement(By.name("group_footer")).click();
        driver.findElement(By.name("group_footer")).sendKeys("group 1 footer");
